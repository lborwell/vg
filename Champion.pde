class Champion extends Creature {
  ...
  public Champion(int x, int y, float or, Main m) {
    super(x, y, or, 0, 0, new int[] {0, 0, 255}, 25, 600, 1000, m);
  ...
  void launchAttack(){
    stalled = true;
    m.attacks.add(new AttackParticle(position, atkTarget, atkDamage, m));
  }
